...
class CezTableImage extends Cezpdf
{
    ...
    public function ezTable(&$data,$cols='',$title='',$options='')
    {
        ...
        if(isset($options['showLines'])) {
            ...
            case 0:    $options['gridlines'] = 0; 
                break;
            case 1:    $options['gridlines'] = EZ_GRIDLINE_DEFAULT; 
                break;
            case 2:    $options['gridlines'] = EZ_GRIDLINE_HEADERONLY + EZ_GRIDLINE_ROWS; 
                break;
            case 3:    $options['gridlines'] = EZ_GRIDLINE_ROWS; 
                break;
            case 4:    $options['gridlines'] = EZ_GRIDLINE_HEADERONLY; 
                break;
